    ...
    <head>
        ...
        <style>
            .schedule-table {
                ...
                white-space: nowrap; /* Không ngắt dòng tự động */
            }
            ...
            .schedule-table th,td {
                ...
                padding: 8px;
                text-align: center;
                width: 15%; /* Điều chỉnh theo ý muốn */
            }
        </style>
            ...
            <div class="container">
                ...
                <div class="row courses_row">
                    <table class="schedule-table">
                        ...
                        <tr>
                            <c:forEach var="lss" items="${lss}" varStatus="loop">
                                <c:if test="${count % 6 == 0}">
                                    <td>${s[countd]}</td>
                                ...
                                <c:if test="${count % 6 == 0 && not loop.last}">
                                </tr><tr>
                                </c:if>
                            </c:forEach>
                        </tr>
