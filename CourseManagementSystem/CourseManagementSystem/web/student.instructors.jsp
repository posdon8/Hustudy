        ...
        <div class="super_container">
            ...
            <div class="instructors">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h2 class="section_title text-center">All Lecturer</h2>
                        </div>
                    </div>
                    <div class="row instructors_row">
                        <c:forEach var="ll" items="${listlecturer}" varStatus="loop">
                            <div class="col-lg-4 instructor_col">
                                <div class="instructor text-center">
                                    <div class="instructor_image_container">
                                        <div class="instructor_image"><img src="assets/images/${ll.avatar}" alt=""></div>
                                    </div>
                                    <div class="instructor_name"><a href="groupbylec?lecid=${ll.userid}">${ll.fullname}</a></div>
                                    <div class="instructor_title">${ll.role}</div>
