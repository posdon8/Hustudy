                            ...
                            <div class="tab_panels">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="instructor d-flex flex-row align-items-center justify-content-start">
                                                    ...
                                                    <div class="instructor_content">
                                                        <div class="instructor_name"><a href="#">${c.userid.fullname}</a></div>
                                ...
                                <div class="tab_panel curriculum">
                                    ...
                                    <div class="curriculum_items">
                                                ...
                                                <div class="cur_item_content">
                                                    ...
                                                    <div class="cur_contents">
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <c:set var="lname" value="listdoc${ll.lessonname}"/><span><a style="color:black;text-decoration: none" href="#" onclick="confirmDelete(${ll.lessonid},${c.courseid})"><i  class="fa fa-times-rectangle"></i></a></span>
                                                                <ul>
                                                                    <c:forEach var="dc" items="${sessionScope[lname]}" varStatus="loop">
                                                                        <li class="d-flex flex-row align-items-center justify-content-start">
                                                                            <i class="fa fa-file" aria-hidden="true"></i><span><a href="${dc.slideurl}" download>${dc.slideurl}</a></span><span><a style="color:black;" href="#" onclick="confirmDelete1(${dc.documentid}, ${c.courseid})"><i  class="fa fa-times-rectangle"></i></a></span>
                                                                        </li>
                                                                    </c:forEach>
                                                                </ul>
                                                                <ul>
                                                                    <li>
                                                                        <form action="lectureradddoc">
                                                                            <i class="fa fa-file" aria-hidden="true"></i>
                                                                            <input type="hidden" name="lessonid" value="${ll.lessonid}"/>
                                                                            <input type="hidden" name="courseid" value="${c.courseid}"/>
                                                                            <input type="file" name="file" id="file" /><input type="submit" value="Add"/>
                                                                        </form>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                    ...
                                                    <script>
                                                        function confirmDelete(lessonid, courseid) {
                                                            ...
                                                            if (result) {
                                                                window.location.href = "lecturerdeletelesson?lid=" + lessonid + "&&cid=" + courseid;
                                                            }
                                                        }
                                                    </script>
                                                    <script>
                                                        function confirmDelete1(documentid, courseid) {
                                                            var result = confirm("Bạn có muốn xóa không?");
                                                            if (result) {
                                                                window.location.href = "lecturerdeletedoc?did=" + documentid + "&&cid=" + courseid;
                                                            }
                                                        }
                                                    </script>
                                                </div>
                                        ...
                                        <div class="cur_item">
                                            <form action="lectureraddlesson" method="get">
                                                <div class="cur_item_content">
                                                    <i class="fa fa-folder" aria-hidden="true"></i>
                                                    <div class="cur_item_title"><input type="text" name="lessonname" placeholder="Enter name of lesson"/></div>
                                                    <input type="hidden" name="courseid" value="${c.courseid}"/>
                                ...
                                <div class="tab_panel members">
                                    ...
                                    <div class="members_list d-flex flex-row flex-wrap align-items-start justify-content-start">
                                        <c:forEach var="lm" items="${listuser}" varStatus="loop">
                                            <div class="member">
                                    ...
                                    <button id="buttonShowBangDiem" onclick="toggleBangDiem()">Bảng Điểm</button>
                                    <button onclick="ExportToExcel('xlsx')">Xuất Excel</button>
                                    <table id="bangdiem">
                                        <thead>
                                            <tr>
                                                <th>Student</th>
                                        ...
                                        <tbody>
                                            <c:forEach var="lgs" items="${listgrade}" varStatus="loop">
                                                <tr>
                                                    <td>${lgs.enrollmentid.userid.fullname}</td>
                                                    <td>${lgs.midtermscore}</td>
                                                    <td>${lgs.finalscore}</td>
                                                    <td>${lgs.average}</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    ...
                                    <script>
                                        function toggleBangDiem() {
                                            var bangdiem = document.getElementById('bangdiem');
                                            bangdiem.style.display = (bangdiem.style.display === 'table') ? 'none' : 'table';
                                        }
                                        function ExportToExcel(type, fn, dl) {
                                            var elt = document.getElementById('bangdiem');
                                            var wb = XLSX.utils.table_to_book(elt, {sheet: "sheet1"});
                                            return dl ?
                                                    XLSX.write(wb, {bookType: type, bookSST: true, type: 'base64'}) :
                                                    XLSX.writeFile(wb, fn || ('bangdiem.' + (type || 'xlsx')));
                                        }
                                    </script>
