                                            ...
                                            <tr>
                                                <td class="image">
                                                    <div class="product_image">
                                                        <a href="#"><img src="assets/images/${co.linkimg}"alt="#" /></a>
                                                    </div>
                                                </td>
                                                <td class="item">
                                                    <a href="/products/dong-ho-nam-skmei-kim-xanh-duong"><strong>${co.title}</strong></a>
                                                </td>
                                                <td class="price" style="color: #e32828">${co.price}$</td>
                                            </tr>
                                    </tbody>
                                </table>
