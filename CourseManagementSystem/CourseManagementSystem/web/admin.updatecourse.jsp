...
<body>
    <div class="login-container">
        ...
        <c:set var="c" value="${courseupdate}"/>
        <h2>Update course</h2>
        <c:if test="${messenger != null}">
            <h3 style="color: #db5360c7">${messenger}</h3>
        </c:if>
        <form action="adminchangecourse" method="post">
            <input type="hidden" name="courseid" value="${c.courseid}"/>
            <div class="form-group">
                <label>Title:</label>
                <input type="text" class="form-control" name="newtitle" placeholder="Enter title" value="${c.title}">
            </div>
            <div class="form-group">
                <label>Description:</label>
                <input type="text" class="form-control" name="newdescription" placeholder="Enter description" value="${c.description}">
            </div>
            <div class="form-group">
                <label>Price:</label>
                <input type="number" class="form-control" name="newfullname" placeholder="Enter price" value="${c.price}" min="1">
            </div>
            <button class="btn btn-primary btn-login"><a href="admincoursedetail?id=${c.courseid}" style="text-decoration: none">Back</a></button>
