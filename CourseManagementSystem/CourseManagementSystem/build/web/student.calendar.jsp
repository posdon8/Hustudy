...
<html lang="en">
    <head>
        ...
        <style>
            ...
            td , th{
                flex: 1; /* Thuộc tính quan trọng: làm cho kích thước của các ô bằng nhau */
                text-align: center;
            }
        </style>
    ...
    <body>
        <div class="super_container">
            ...
            <div class="courses">
                <div class="courses" style="height: 510px">
                    <div class="courses_background"></div>
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <h2 class="section_title text-center">My calendar</h2>
                            </div>
                        </div>
                        <div class="row courses_row">
                            <div class="row courses_row">
                                <table border="1">
                                    <c:set var="countd" value="0" />
                                    <c:set var="s" value="${s}"/>
                                    <tr>
                                        <th>&nbsp;</th>
                                        <th>Slot 1</th>
                                    ...
                                    <c:forEach var="sh" items="${sh}" varStatus="loop">
                                        <c:if test="${loop.index % 6 == 0}">
                                            <tr>
                                                <td>${s[countd]}</td>
                                                <c:set var="countd" value="${countd + 1}" />
                                            </c:if>
                                            <td>
                                                
                                                <c:forEach var="ls" items="${ls}">
                                                    <c:if test="${sh.shiftid eq ls.shiftid.shiftid}">
                                                        <c:out value="[${ls.courseid.title}]"/><br/>
                                                    </c:if>
                                                </c:forEach>
                                            </td>
