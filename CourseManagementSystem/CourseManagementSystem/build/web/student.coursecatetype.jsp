        ...
        <div class="super_container">
                                ...
                                <div class="owl-carousel owl-theme language_slider">
                                    <c:forEach var="lc" items="${listcate}" varStatus="loop">
                                        <div class="owl-item language_item"style="padding-bottom: 150px; padding-top: 90px">
                                            <div class="dropdown1">
                                                <a href="groupbycate?cate=${lc.categoryname}">
                                                ...
                                                <div class="dropdown-content1">
                                                    <ul style="background: transparent;">
                                                        ...
                                                        <li style="padding: 5px; border-radius: 10px"><a href="groupbycatetype?cate=${lc.categoryname}&&type=${tc.typecoursename}" style="color: rgba(0,0,0,0.4); font-weight: bold">${tc.typecoursename}</a></li>
                                                        </c:forEach>
                                                    </ul>
                                                </div>
                                            </div>
            ...
            <div class="courses" style="padding-top: 0px">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h2 class="section_title text-center">All courses of ${cate} , ${type}  </h2>
                        </div>
                    </div>
                    <div class="row courses_row">

                        <!-- Course -->
                        <c:forEach var="c" items="${coursecatetype}" varStatus="loop">
