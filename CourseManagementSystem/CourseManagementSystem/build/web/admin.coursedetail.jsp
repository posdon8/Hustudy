                    ...
                    <div class="row row-lg-eq-height">
                        ...
                        <div class="col-lg-3">
                            <div class="sidebar">
                                ...
                                <div class=" sidebar_top" style="border: solid 1px #ffffff;"><a href="adminupdatecourse?id=${c.courseid}">Update course</a></div>
                                <div class=" sidebar_top" style="border: solid 1px #ffffff;"><a href="#" onclick="confirmDelete(${c.courseid})">Delete course</a></div>
                                <script>
                                    function confirmDelete(courseid) {
                                        var result = confirm("Bạn có muốn xóa không?");
                                        if (result) {
                                            window.location.href = "admindeletecourse?id=" + courseid;
                                        }
                                    }
                                </script>
