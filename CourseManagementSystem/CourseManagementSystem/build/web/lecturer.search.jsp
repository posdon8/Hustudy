        ...
        <div class="language">
            ...
            <div class="courses">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h2 class="section_title text-center">Results for keywords: ${keyword}</h2>
                        </div>
                    </div>
                    <div class="row courses_row">
                        <c:forEach var="c" items="${lsc}" varStatus="loop">
                            <div class="col-lg-4 course_col">
                                <div class="course">
                                    <div class="course_image"><a href="coursedetail?id=${c.courseid}&&userid=${u.userid}"><img src="assets/images/${co.linkimg}" alt=""></a></div>
                        ...
                        <c:forEach var="l" items="${lsl}" varStatus="loop">
                            <div class="col-lg-4 instructor_col">
                                <div class="instructor text-center">
                                    <div class="instructor_image_container">
                                        <div class="instructor_image"><img src="assets/images/${l.avatar}" alt=""></div>
                                    </div>
                                    <div class="instructor_name"><a href="groupbylec?lecid=${l.userid}">${l.fullname}</a></div>
                                    <div class="instructor_title">${l.role}</div>
